<template>
  <div class="qr-tile">
    ...
    <div class="print-only">
      ...
      <p class="version">
        Please go to <a href="https://stewit.github.io/banana_split/">https://stewit.github.io/banana_split/</a> to download
        the reconstruction webapp, if you don't have one already. <br />
        This has been generated by BananaSplit fork version {{ gitRevision }} <br />
        ipfs cid: {{ ipfsCid }}
      </p>
    </div>
  </div>
